...
一个集成了多种实用工具的在线工具箱，采用微前端架构和侧边栏导航设计，提供便捷的工具切换体验。

## 项目简介

工具集合站是一个将多个独立 Web 应用整合在一起的统一平台，用户可以通过简洁的侧边栏导航在不同工具之间快速切换，无需打开多个标签页。采用 iframe 隔离技术，确保各工具独立运行、互不干扰。

## 包含的工具

### 📝 节点知识库
知识关系图谱可视化工具，帮助你构建和管理知识网络。
- 可视化知识图谱展示
- 节点创建、编辑和删除
- 父子关系管理
- 标签分类系统
